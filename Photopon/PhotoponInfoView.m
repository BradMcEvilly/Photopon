...
@implementation PhotoponInfoView
...
+ (PhotoponInfoView *)PhotoponInfoViewWithTitle:(NSString *)titleText message:(NSString *)messageText cancelButton:(NSString *)cancelText {
    NSArray *arr = [[NSBundle mainBundle] loadNibNamed:@"PhotoponInfoView" owner:nil options:nil];
    PhotoponInfoView *view = [arr objectAtIndex:0];
