...
static CGFloat min_width_iphone = 320.0f;

static CGFloat min_width_ipad   = 600.0f;
...
-(void)_adjustSizesForPagesCoreInit {
    ...
    if (loopPageNumber>0)
        ...
        [self setContentSize:CGSizeMake(min_width_iphone, currentSize.height)];
}
