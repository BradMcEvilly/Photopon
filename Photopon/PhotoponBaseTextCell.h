...
@class PhotoponProfileImageView;
@protocol PhotoponBaseTextCellDelegate;

@interface PhotoponBaseTextCell : UITableViewCell <AMAttributedHighlightLabelDelegate>{
 ...
 */
@protocol PhotoponBaseTextCellDelegate <NSObject>
@optional
