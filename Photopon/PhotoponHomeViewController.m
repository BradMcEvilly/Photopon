...
@interface PhotoponHomeViewController ()

@end

@implementation PhotoponHomeViewController
...
- (void) showShareSheet{
    ...
    UIImage *i = [[UIImage alloc] initWithContentsOfFile:[[PhotoponMediaModel newPhotoponDraft] screenshotLocalURL]];
